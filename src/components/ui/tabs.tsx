  ...
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      variant === "default"
        ...
        : "w-full justify-start gap-2 border-b text-muted-foreground",
      className
    )}
    {...props}
  />
  ...
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      variant === "default"
        ...
        : "relative h-9 rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:text-foreground",
      className
    )}
    {...props}
  />
